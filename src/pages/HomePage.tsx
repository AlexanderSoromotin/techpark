  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Промышленный технопарк полного цикла в Троицке, Челябинская область. Аренда производственных помещений от 50 м². 7 отраслей производства. Готовая инфраструктура, поддержка бизнеса. ☎ +7 (908) 047-70-30" />
        <link rel="canonical" href={`${SITE_URL}/`} />
        {/* Open Graph */}
        <meta property="og:title" content="Технопарк 1219 — Промышленный технопарк в Троицке" />
        <meta property="og:description" content="Аренда производственных помещений от 50 м² в Троицке. Готовые цеха с коммуникациями, поддержка бизнеса, 7 отраслей производства." />
