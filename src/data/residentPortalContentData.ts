    ...
    knowledgeArticles: [
      {
        ...
        content: 'Лазерная резка обеспечивает высокую точность и минимальный термический нагрев кромки, что важно для сложных деталей и чистовых изделий. Плазменная резка быстрее и дешевле на большой толщине металла, но даёт более широкий рез и окалину. Для тонкого листа, корпусов оборудования и декоративных элементов выбирайте лазер. Для раскроя толстой конструкционной стали — плазму.',
        contentBlocks: [
          { type: 'text', text: 'Лазерная резка обеспечивает высокую точность реза и минимальный нагрев кромки. Подходит для деталей сложной формы, корпусов и изделий с последующей сваркой.' },
          { type: 'image', src: '/residents/metalworks.svg', alt: 'Лазерная и плазменная резка металла', caption: 'Сравнение методов резки' },
          { type: 'text', text: 'Плазменная резка выгоднее при работе с толстым металлом от 10 мм и выше. Для чернового раскроя заготовок под сварку — оптимальный выбор по соотношению скорости и цены.' },
        ],
      ...
      },
      {
        ...
        content: 'Порошковая покраска образует твёрдое полимерное покрытие после запекания в термокамере. Оно устойчиво к механическим повреждениям, коррозии и ультрафиолету. Жидкая покраска подходит для крупногабаритных конструкций, которые не помещаются в камеру, а также для изделий, требующих нанесения покрытия на объекте. Порошок — для серийных деталей и мебели, жидкость — для крупных металлоконструкций.',
        contentBlocks: [
          { type: 'text', text: 'Порошковое покрытие запекается в термокамере и образует однородную плёнку без подтёков. Такая отделка устойчива к истиранию, коррозии и выцветанию на улице.' },
          { type: 'image', src: '/residents/metalworks.svg', alt: 'Покраска металлических изделий', caption: 'Финишная обработка металла' },
          { type: 'text', text: 'Жидкая краска используется там, где изделие нельзя поместить в камеру из-за размера, или когда требуется нанесение в несколько слоёв с промежуточной сушкой.' },
        ],
        image: '/residents/metalworks.svg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        content: 'Часто думают, что металлическая мебель дороже деревянной без явных преимуществ. Но для производственных помещений металл выигрывает по всем параметрам: он не горит, не деформируется от влажности, выдерживает тяжёлый инструмент и агрессивные среды. Металлические верстаки и стеллажи изготавливаются под размеры помещения, что исключает потерю рабочего пространства.',
        contentBlocks: [
          { type: 'text', text: 'Деревянные верстаки в производственных помещениях быстро приходят в негодность от масел, металлической стружки и воздействия температуры. Металл в этих условиях работает десятилетиями.' },
          { type: 'image', src: '/residents/metalworks.svg', alt: 'Металлические верстаки и стеллажи', caption: 'Металлическая мебель для производства' },
          { type: 'text', text: 'Изготовление под размеры позволяет использовать каждый сантиметр рабочей зоны. Стандартные варианты из магазина редко подходят под нестандартные площади цехов и мастерских.' },
        ],
        image: '/residents/metalworks.svg',
        readTime: '4 мин',
  ...
  hydraulics: {
    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        content: 'Если повреждён фитинг или небольшой участок рукава, во многих случаях достаточно локального ремонта: замены фитинга, укорачивания или наращивания. Полная замена нужна, когда рукав расслоился по всей длине, имеет множественные вспучивания или не соответствует рабочим параметрам. Ремонт обходится дешевле и выполняется быстрее.',
        contentBlocks: [
          { type: 'text', text: 'Замена фитинга с повторной опрессовкой — самый частый вид ремонта. Если рукав в целом исправен, это занимает 15–20 минут и стоит значительно дешевле нового РВД.' },
          { type: 'image', src: '/residents/hydraulics.svg', alt: 'Ремонт и замена РВД', caption: 'Диагностика рукава высокого давления' },
          { type: 'text', text: 'Полную замену рекомендуем при видимых расслоениях, грыжах и при истёкшем сроке эксплуатации. Не ждите аварийного разрыва — плановая замена безопаснее.' },
        ],
      ...
      },
      {
        ...
        content: 'Рукав с заниженным рабочим давлением разорвётся раньше времени. Рукав с несовместимыми фитингами либо не встанет, либо будет течь. Внутренний диаметр влияет на скорость потока жидкости и КПД всей гидросистемы. Для спецтехники и промышленного оборудования критически важно использовать именно те параметры, которые заложены в конструкцию.',
        contentBlocks: [
          { type: 'text', text: 'Рабочее давление РВД должно соответствовать или превышать давление в системе. Занижение параметра даже на 10% существенно сокращает ресурс и повышает риск разрыва под нагрузкой.' },
          { type: 'image', src: '/residents/hydraulics.svg', alt: 'Параметры рукава высокого давления', caption: 'Подбор РВД по параметрам системы' },
          { type: 'text', text: 'Мы изготавливаем рукава диаметром до 72 мм. Для нестандартных конфигураций подберём аналоги с сохранением рабочих параметров.' },
        ],
        image: '/residents/hydraulics.svg',
        readTime: '4 мин',
    ...
    knowledgeArticles: [
      {
        ...
        content: 'Изношенные крестовины дают характерный стук при трогании с места и торможении, а также вибрацию на определённых скоростях. Проверить состояние просто: покачайте вал руками поперёк оси — люфт укажет на износ. Затягивать с заменой не стоит: разрушенная крестовина может повредить тоннель кузова или коробку передач.',
        contentBlocks: [
          { type: 'text', text: 'Первый признак износа крестовин — стук при изменении нагрузки на трансмиссию. Вибрация на скорости 60–100 км/ч также часто указывает на проблему с карданным валом.' },
          { type: 'image', src: '/residents/driveshafts.svg', alt: 'Замена крестовин карданного вала', caption: 'Диагностика и замена крестовин' },
          { type: 'text', text: 'После замены крестовин обязательна балансировка вала. Без неё вибрация может сохраниться даже с новыми деталями.' },
        ],
      ...
      },
      {
        ...
        content: 'Балансировка необходима после любого ремонта, связанного с изменением массы или геометрии вала: замены крестовин, восстановления посадочных мест, наварки. Без балансировки остаточный дисбаланс быстро разрушает подшипники трансмиссии. Если вибрация сохраняется после замены крестовин — причина именно в дисбалансе.',
        contentBlocks: [
          { type: 'text', text: 'Дисбаланс в 1–2 граммах на краю вала создаёт центробежную силу, которая на рабочих оборотах нагружает подшипники как удар. Даже небольшая несимметричность ощутимо сокращает ресурс узлов.' },
          { type: 'image', src: '/residents/driveshafts.svg', alt: 'Балансировка карданного вала', caption: 'Балансировочный станок' },
          { type: 'text', text: 'Балансируем валы всех типоразмеров для легкового и грузового транспорта, спецтехники и промышленного оборудования.' },
        ],
        image: '/residents/driveshafts.svg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        content: 'Сварка при восстановлении тонкостенных деталей часто приводит к деформации и нарушению геометрии. Металлизация (термическое напыление) наращивает металл без значительного нагрева заготовки, сохраняя точность формы. После напыления деталь шлифуется до нужного размера. Это позволяет восстановить посадочные места под подшипники и крестовины без замены детали целиком.',
        contentBlocks: [
          { type: 'text', text: 'Термическое напыление металла не нагревает деталь выше 80–120°C, что исключает деформацию и изменение структуры металла. Сварка в тех же зонах даёт температуру от 1500°C.' },
          { type: 'image', src: '/residents/driveshafts.svg', alt: 'Металлизация деталей кардана', caption: 'Восстановление методом напыления' },
          { type: 'text', text: 'После металлизации выполняем шлифовку до проектного размера с точностью до 0.01 мм. Восстановленная деталь по ресурсу сопоставима с новой.' },
        ],
        image: '/residents/driveshafts.svg',
        readTime: '5 мин',
    ...
    knowledgeArticles: [
      {
        ...
        content: 'С8 с высотой волны 8 мм — лёгкий профиль для заборов, фасадов и временных ограждений. С21 высотой волны 21 мм значительно жёстче и подходит для кровли и стеновых конструкций с нагрузкой от снега и ветра. Использование С8 там, где нужен С21, приведёт к прогибам и протечкам. Лишняя масса С21 на заборе — это переплата без пользы.',
        contentBlocks: [
          { type: 'text', text: 'Для заборов и декоративных фасадов достаточно профлиста С8. Это оптимальное соотношение жёсткости и стоимости для вертикальных конструкций без снеговой нагрузки.' },
          { type: 'image', src: '/residents/metalworks.svg', alt: 'Выбор профлиста', caption: 'Профлист разных профилей' },
          { type: 'text', text: 'Для кровли с уклоном от 8° и более рекомендуем С21 или аналоги с волной 20–25 мм. При пролётах от 1.5 м без промежуточных опор — тем более.' },
        ],
        image: '/residents/metalworks.svg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        content: '3D заборы из сварной сетки устойчивы к ветровой нагрузке лучше, чем сплошной профлист: ветер проходит сквозь ячейки, не создавая парусности. Сплошной профлист требует более мощных опорных столбов именно из-за ветра. Сетчатые ограждения хорошо подходят для периметра промышленных объектов, парковок и муниципальных территорий.',
        contentBlocks: [
          { type: 'text', text: 'Сварная сетка 3D заборов производится на автоматических линиях с точными параметрами ячейки и диаметра проволоки. Это обеспечивает предсказуемую прочность по всей длине секции.' },
          { type: 'image', src: '/residents/fasteners.svg', alt: '3D заборы и ограждения', caption: 'Секционные ограждения из сварной сетки' },
          { type: 'text', text: 'Для участков с высокой ветровой нагрузкой рекомендуем рассмотреть 3D забор вместо профлистового: меньше нагрузка на столбы, проще монтаж и дольше срок службы при тех же вложениях.' },
        ],
      ...
      },
      {
        ...
        content: 'Габионы — это гибкие проволочные короба, заполненные камнем. Они пропускают воду, не создавая гидростатического давления, и адаптируются к просадкам грунта без разрушения. Матрасы Рено используют для пологих откосов и русел рек. Ключевое преимущество перед бетоном — возможность частичного ремонта и экологичность конструкции.',
        contentBlocks: [
          { type: 'text', text: 'Габионные конструкции не требуют фундамента и специальной техники для монтажа. Засыпка камнем может выполняться вручную или экскаватором в зависимости от объёма.' },
          { type: 'image', src: '/residents/container-homes.svg', alt: 'Габионные конструкции', caption: 'Коробчатые габионы и матрасы Рено' },
          { type: 'text', text: 'Для дорожных откосов, берегоукрепления и противоэрозионных работ матрасы Рено — стандартное инженерное решение с многолетней практикой применения в России.' },
        ],
    ...
    knowledgeArticles: [
      {
        ...
        content: 'Круглые воздуховоды имеют меньшее гидравлическое сопротивление при одинаковом сечении, что снижает нагрузку на вентилятор и уровень шума. Прямоугольные удобнее размещать в ограниченном пространстве подвесных потолков — они занимают меньше высоты. Для промышленной вентиляции обычно выбирают круглые, для офисных и торговых помещений — прямоугольные.',
        contentBlocks: [
          { type: 'text', text: 'Круглые воздуховоды производятся методом вальцовки и имеют жёсткий фальцевый шов. Они проще монтируются на прямых участках, но сложнее в поворотах без фасонных элементов.' },
          { type: 'image', src: '/residents/hydraulics.svg', alt: 'Круглые и прямоугольные воздуховоды', caption: 'Сравнение типов воздуховодов' },
          { type: 'text', text: 'Прямоугольные воздуховоды часто предпочтительны в жилых и коммерческих объектах из-за удобства скрытого монтажа за подвесными потолками. Высота сечения может быть всего 100–150 мм.' },
        ],
        image: '/residents/hydraulics.svg',
        readTime: '5 мин',
      ...
      },
      {
        ...
        content: 'Распространённое заблуждение: фасонные элементы можно заменить самодельными врезками или обойтись без них. Это ведёт к турбулентности, потерям давления и повышенному шуму. Переходы между разными диаметрами, отводы с правильным радиусом изгиба и тройники с нужным углом — это расчётные элементы, влияющие на баланс всей вентиляционной сети.',
        contentBlocks: [
          { type: 'text', text: 'Резкий переход между диаметрами без конического переходника создаёт зону вихреобразования. В таком месте теряется до 20–30% скорости потока.' },
          { type: 'image', src: '/residents/hydraulics.svg', alt: 'Фасонные элементы вентиляции', caption: 'Переходы и отводы для воздуховодов' },
          { type: 'text', text: 'Изготавливаем фасонные элементы под нестандартные размеры и конфигурации. Каждая деталь производится по схеме заказчика или рассчитывается по параметрам системы.' },
        ],
        image: '/residents/hydraulics.svg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        content: 'Монтаж без предварительного проекта часто приводит к тому, что воздуховоды не вписываются в пространство, мощность вентилятора недостаточна или система шумит. Проект позволяет заранее просчитать сечения воздуховодов, расположение оборудования и спецификацию материалов. Изготовление элементов под проект исключает переделки и остатки.',
        contentBlocks: [
          { type: 'text', text: 'Проектирование вентиляции начинается с расчёта воздухообмена по нормам СНиП или по техническому заданию заказчика. На основе этого подбирается оборудование и сечения воздуховодов.' },
          { type: 'image', src: '/residents/hydraulics.svg', alt: 'Проектирование вентиляционной системы', caption: 'Схема вентиляционной системы' },
          { type: 'text', text: 'Готовим схемы воздуховодов, спецификации материалов и производственные чертежи. Это позволяет изготовить все элементы точно и с минимальными отходами.' },
        ],
        image: '/residents/hydraulics.svg',
        readTime: '5 мин',
    ...
    knowledgeArticles: [
      {
        ...
        content: 'Обычный гвоздь держится за счёт трения между гладкой поверхностью и древесиной. При усыхании или набухании дерева фиксация ослабевает. Ершёный гвоздь с кольцевой насечкой работает иначе: волокна дерева заходят в канавки и буквально «захватывают» гвоздь. Усилие на вырыв у ершёного гвоздя в 3–5 раз выше. Используется в поддонах, настилах, каркасах и конструкциях с вибрационной нагрузкой.',
        contentBlocks: [
          { type: 'text', text: 'Для строительных лесов, настилов и деревянных поддонов, которые подвергаются циклическим нагрузкам, ершёный гвоздь — правильный выбор. Обычный в таких условиях постепенно выходит.' },
          { type: 'image', src: '/residents/fasteners.svg', alt: 'Ершёные и строительные гвозди', caption: 'Сравнение типов гвоздей' },
          { type: 'text', text: 'Выпускаем ершёные гвозди длиной от 40 до 120 мм. Возможно изготовление по ГОСТ и под нестандартные размеры партии.' },
        ],
        image: '/residents/fasteners.svg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        content: 'Саморез по дереву имеет крупную редкую резьбу: она врезается в мягкие волокна и обеспечивает прочное удержание. Саморез по металлу — мелкая частая резьба, острый наконечник и более твёрдый материал. Если вкрутить «деревянный» саморез в листовой металл, резьба не зацепит — соединение будет ненадёжным. И наоборот: по дереву «металлический» саморез расщепит волокна.',
        contentBlocks: [
          { type: 'text', text: 'Для крепления профлиста и металлических профилей используйте только саморезы по металлу. Для деревянной обрешётки под профлист — по дереву. Смешивать нельзя.' },
          { type: 'image', src: '/residents/fasteners.svg', alt: 'Саморезы по металлу и дереву', caption: 'Виды саморезов и область применения' },
          { type: 'text', text: 'Кровельные саморезы с EPDM-шайбой — отдельная категория для наружных работ. Шайба обеспечивает герметичность прохода через профлист и защищает от попадания воды.' },
        ],
        image: '/residents/fasteners.svg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        content: 'Нестандартный крепёж заказывают когда стандартные размеры не подходят по посадке, длине или форме головки; когда нужен специфический материал или покрытие; когда задача требует уникальной геометрии. Для заказа достаточно образца, чертежа или описания с размерами. Производим от единичных экземпляров до серийных партий методом штамповки, гибки или накатки резьбы.',
        contentBlocks: [
          { type: 'text', text: 'Чаще всего нестандартный крепёж заказывают для промышленного оборудования, специальных монтажных систем и когда оригинальные детали сняты с производства.' },
          { type: 'image', src: '/residents/fasteners.svg', alt: 'Нестандартный крепёж по чертежам', caption: 'Изготовление крепежа по образцу' },
          { type: 'text', text: 'Для расчёта стоимости достаточно прислать фото образца с указанием размеров или эскиз. Производство от 1 штуки — это реально.' },
        ],
        image: '/residents/fasteners.svg',
        readTime: '5 мин',
    ...
    knowledgeArticles: [
      {
        ...
        content: 'Основные параметры сварочного стола: толщина столешницы (от 10 мм для тяжёлых работ), наличие отверстий под упоры и зажимы, конструкция каркаса. Лёгкий стол без рёбер жёсткости деформируется от температуры сварки. Столы с отверстиями позволяют использовать прижимную оснастку и точно фиксировать детали. Изготавливаем по размерам рабочего места и под конкретные задачи.',
        contentBlocks: [
      ...
      },
      {
        ...
        content: 'Нестандартное оборудование заказывают когда серийный аналог не подходит по размерам, производительности или условиям эксплуатации. Для описания задачи достаточно: что должно делать оборудование, в каких условиях работать, какие материалы обрабатывать и каков ожидаемый ресурс. Разрабатываем конструкцию от эскиза до рабочих чертежей и изготовления.',
        contentBlocks: [
      ...
      },
      {
        ...
        content: 'Главная ошибка — подбор установки по площади помещения без учёта интенсивности пылевыделения. Для сварочного участка, деревообработки и металлообработки нормы кратно различаются. Второй момент — фильтрация: тонкая пыль металла и дерева требует фильтров с высоким классом очистки. Изготавливаем установки под конкретный технологический процесс с нужной производительностью.',
        contentBlocks: [
    ...
    knowledgeArticles: [
      {
        ...
        content: 'Для промышленной переработки хорошо подходят ПНД (полиэтилен высокой плотности), ПП (полипропилен) и ПЭТ в чистом виде. Многослойные упаковки, ПВХ с примесями, загрязнённый пластик и смеси разных полимеров значительно сложнее в переработке. Производственный брак, облой и чистые обрезки — идеальное сырьё для дробления и последующего использования.',
        contentBlocks: [
          { type: 'text', text: 'Производственный брак из монопластика перерабатывается эффективнее всего: он химически однороден и не требует сортировки. Один тип пластика — максимальная ценность на выходе.' },
          { type: 'image', src: '/residents/3d-printing.svg', alt: 'Переработка пластиковых отходов', caption: 'Промышленная переработка пластика' },
          { type: 'text', text: 'Принимаем производственные отходы ПЭТ, ПНД и ПП. Для уточнения условий и объёмов свяжитесь с нами напрямую.' },
        ],
      ...
      },
      {
        ...
        content: 'Для измельчения подходят обрезки досок, горбыль, поддоны без металлических элементов, стружка и опилки крупной фракции. Ламинированные плиты (ЛДСП, МДФ) с клеевыми составами обрабатываются отдельно. ДСП со значительным содержанием связующего нежелательна для чистой щепы. Чистая древесная щепа находит применение в котельных, производстве топливных брикетов и в сельском хозяйстве.',
        contentBlocks: [
          { type: 'text', text: 'Мебельные предприятия, деревообрабатывающие производства и строительные компании регулярно накапливают большой объём чистых древесных отходов, которые можно превратить в вторичное сырьё.' },
          { type: 'image', src: '/residents/3d-printing.svg', alt: 'Переработка дерева в щепу', caption: 'Шредирование древесных отходов' },
          { type: 'text', text: 'Принимаем деловые отходы лесопиления и деревообработки. Обговариваем условия по объёмам и периодичности поставок.' },
        ],
        image: '/residents/3d-printing.svg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        content: 'Вторичный дроблёный пластик из монопотока промышленного производства по своим характеристикам близок к первичному гранулят. Смешанные бытовые отходы действительно дают материал худшего качества. Вторичная щепа от чистой древесины — полноценное топливо или наполнитель. Ключевой фактор — чистота и однородность исходного сырья, а не факт переработки как таковой.',
        contentBlocks: [
          { type: 'text', text: 'Промышленные отходы производства имеют известный состав и минимальное загрязнение. Это радикально отличает их от бытовых отходов смешанного происхождения.' },
          { type: 'image', src: '/residents/3d-printing.svg', alt: 'Вторичное сырьё из переработки', caption: 'Качество вторичного сырья' },
          { type: 'text', text: 'Вторичный дроблёный пластик из монопотока используется в производстве технических изделий, плёнки и строительных материалов. Для ряда применений он неотличим от первичного.' },
        ],
        image: '/residents/3d-printing.svg',
        readTime: '5 мин',
    ...
    knowledgeArticles: [
      {
        ...
        content: 'Штамп — это инструмент для разделительных и формообразующих операций: вырубки, гибки, вытяжки. Пресс-оснастка — более широкое понятие, включающее штампы, матрицы, пуансоны и вспомогательные приспособления. Если нужно серийно производить одну деталь методом холодной штамповки — нужен штамп. Если задача шире — разрабатывается комплект оснастки.',
        contentBlocks: [
      ...
      },
      {
        ...
        content: 'Ремонт штампа оправдан при локальном износе режущих кромок, трещинах в неосновных зонах и при замене отдельных вставных элементов. Новый штамп нужен при смене конструкции детали, значительной деформации корпуса или когда ремонт обходится дороже 70% стоимости нового. Для принятия решения необходима дефектовка.',
        contentBlocks: [
      ...
      },
      {
        ...
        content: 'Для заказа пуансона или матрицы нужно указать: марку материала заготовки и его толщину, размеры и форму детали с допусками, тип операции (вырубка, пробивка, гибка), тип пресса и его параметры. Если есть чертёж детали — этого достаточно для расчёта. Без чертежа можно предоставить образец готовой детали.',
        contentBlocks: [
    ...
    knowledgeArticles: [
      {
        ...
        content: 'FDM (послойное наплавление пластика) подходит для функциональных прототипов, корпусов и крупных деталей. Поверхность шероховатая, но прочность хорошая, а стоимость ниже. SLA (фотополимерная печать) даёт гладкую поверхность и высокую детализацию — идеально для мастер-моделей, ювелирных прототипов и деталей с тонкими элементами. Выбор зависит от назначения детали, а не от красоты технологии.',
        contentBlocks: [
          { type: 'text', text: 'FDM оптимален для функциональных испытаний, корпусов оборудования, кронштейнов и деталей с большими линейными размерами. Материалы: PLA, PETG, ABS, TPU — каждый под свои условия.' },
          { type: 'image', src: '/residents/3d-printing.svg', alt: 'FDM и SLA 3D-печать', caption: 'Сравнение технологий печати' },
          { type: 'text', text: 'SLA используем для мастер-моделей под заливку силикона, для деталей с резьбой мелкого шага и для изделий, требующих финишного качества поверхности без постобработки.' },
        ],
        image: '/residents/3d-printing.svg',
        readTime: '5 мин',
      ...
      },
      {
        ...
        content: 'Для 3D-печати модель должна быть «манифолдной» (водонепроницаемой): без дырок, перевёрнутых нормалей и пересекающихся поверхностей. Файлы из САПР для обычного производства часто содержат такие дефекты — они не мешают чертежу, но ломают печать. Кроме того, нужно учесть ориентацию детали на столе, зоны поддержек и усадку материала. Подготовка к печати — отдельный этап.',
        contentBlocks: [
          { type: 'text', text: 'Часто заказчики присылают STEP или STL из САПР-системы, где деталь проектировалась для мехобработки. Такие модели нередко требуют переработки геометрии под особенности 3D-печати.' },
          { type: 'image', src: '/residents/3d-printing.svg', alt: '3D-моделирование для печати', caption: 'Подготовка модели к 3D-печати' },
          { type: 'text', text: 'Выполняем полный цикл подготовки: от CAD-модели до настройки слайсера с оптимальными параметрами под материал и геометрию детали.' },
        ],
        image: '/residents/3d-printing.svg',
        readTime: '5 мин',
      ...
      },
      {
        ...
        content: 'Для проверки концепции и подгонки геометрии достаточно 1–2 прототипов. Если деталь нужна в количестве 5–50 штук для тестовой партии или поставки — малая серия 3D-печатью может быть выгоднее оснастки под литьё. Порог, после которого литьё становится дешевле, обычно от 200–500 штук в зависимости от сложности. Рассчитаем оба варианта под ваш объём.',
        contentBlocks: [
          { type: 'text', text: 'Прототип позволяет обнаружить проблемы геометрии и эргономики до запуска в серию. Исправить CAD-модель — это часы работы, переделать оснастку для литья — десятки тысяч рублей.' },
          { type: 'image', src: '/residents/3d-printing.svg', alt: 'Прототипирование и малые серии', caption: 'Прототипы и тестовые партии' },
          { type: 'text', text: 'Для малых серий используем наиболее подходящий материал и технологию — с учётом требований к прочности, термостойкости и внешнему виду готового изделия.' },
        ],
        image: '/residents/3d-printing.svg',
        readTime: '4 мин',
    ...
    knowledgeArticles: [
      {
        ...
        content: '20-футовый модуль (14.8 м²) — компактный вариант для гостевого домика, бытовки или офиса на стройке. 30 футов (22 м²) позволяют разместить спальню и полноценный санузел. 40 футов (29.7 м²) — это жилой дом с гостиной, кухней и спальней. Важный момент: 40-футовые модули требуют длинномерного транспорта, что нужно учитывать при планировании доставки.',
        contentBlocks: [
          { type: 'text', text: '20-футовый контейнер доставляется обычным грузовиком с манипулятором. 40-футовый требует длинномер или трал, что важно при ограниченном въезде на участок.' },
          { type: 'image', src: '/residents/container-homes.svg', alt: 'Жилые модули разных размеров', caption: 'Выбор размера жилого модуля' },
          { type: 'text', text: 'Для служебного размещения бригад на объектах часто выбирают блок-комплект из двух 20-футовых модулей: гибко, дёшево в транспортировке и просто в расстановке.' },
        ],
        image: '/residents/container-homes.svg',
        readTime: '5 мин',
      ...
      },
      {
        ...
        content: 'Металлический корпус контейнера с правильным утеплением работает не хуже деревянного сруба. Ключевые факторы: многослойный пирог стены с минеральной ватой или ППУ, качественная пароизоляция и внутренняя вагонка из термостойкой древесины (липа, кедр). Такая баня прогревается быстрее деревянной и легче обслуживается. Главное — качество изоляции, а не материал каркаса.',
        contentBlocks: [
          { type: 'text', text: 'Пенополиуретановое (ППУ) утепление 80 мм или минеральная вата 100 мм обеспечивают тепловое сопротивление, аналогичное бревенчатому срубу 200 мм. При этом стена тоньше и не даёт усадки.' },
          { type: 'image', src: '/residents/container-homes.svg', alt: 'Модульная баня из контейнера', caption: 'Банный модуль с утеплением' },
          { type: 'text', text: 'Устанавливаем парные вместимостью от 4 до 8 человек с электрокаменкой или дровяной печью по выбору заказчика.' },
        ],
        image: '/residents/container-homes.svg',
        readTime: '5 мин',
      ...
      },
      {
        ...
        content: 'Все модули поставляются с готовой внутренней разводкой электрики, водоснабжения и канализации. Для подключения к сетям нужны: ввод электричества 220В (или 380В для мощных потребителей), подвод воды и отвод канализации на участке. Если сетей нет — обсуждаем автономные решения: септик, накопительные баки, генератор или солнечная панель.',
        contentBlocks: [
          { type: 'text', text: 'Электрика в модуле выполнена с чистовой разводкой, щитком и розетками. На вводе достаточно подключить кабель от точки учёта — всё остальное уже готово.' },
          { type: 'image', src: '/residents/container-homes.svg', alt: 'Подключение коммуникаций к модулю', caption: 'Коммуникации жилого модуля' },
          { type: 'text', text: 'Для удалённых объектов без центральных сетей проектируем автономные решения: септики, накопительные ёмкости для воды и автономные системы электроснабжения.' },
        ],
        image: '/residents/container-homes.svg',
        readTime: '4 мин',
