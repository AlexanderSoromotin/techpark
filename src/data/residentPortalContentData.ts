    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'text', text: 'Полная замена нужна при: грыжах и вздутиях на оболочке, расслоении внутреннего слоя, глубоких порезах до армирования, сильной деформации по всей длине или истёкшем сроке службы (обычно 5–7 лет). Такой рукав ненадёжен даже после частичного ремонта — высокое давление может привести к разрыву в любой момент.' },
