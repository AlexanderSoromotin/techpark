    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/hydraulics-kb-5-fittings.jpg', alt: 'Сравнение фитингов BSP, JIC и ORFS — разные стандарты резьбы', caption: 'Фитинги BSP, JIC, ORFS: один размер, разная геометрия уплотнения' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/hydraulics-kb-5-fittings.jpg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/hydraulics-kb-6-crimper.jpg', alt: 'Потение рукава высокого давления — признак деградации материала', caption: 'Масляная пропитка внешней оплётки — сигнал к немедленной замене' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/hydraulics-kb-6-crimper.jpg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/hydraulics-kb-7-banjo.jpg', alt: 'Промывка гидравлической системы после ремонта РВД', caption: 'Промывка системы — обязательный шаг после аварийного ремонта' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/hydraulics-kb-7-banjo.jpg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/hydraulics-kb-8-fitting.jpg', alt: 'Нержавеющие и стальные оцинкованные фитинги для РВД', caption: 'Нержавеющие фитинги — для агрессивных сред и пищевого производства' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/hydraulics-kb-8-fitting.jpg',
        readTime: '4 мин',
    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/driveshafts-kb-4-wheel.jpg', alt: 'Правка колёсного диска после деформации', caption: 'Правка диска восстанавливает геометрию без замены — при отсутствии трещин' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/driveshafts-kb-4-wheel.jpg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/driveshafts-kb-5-lug.jpg', alt: 'Балансировка колёс на стенде после шиномонтажа', caption: 'Балансировочный стенд определяет дисбаланс с точностью до 1 грамма' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/driveshafts-kb-5-lug.jpg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/driveshafts-kb-6-shaft.jpg', alt: 'Диагностика трансмиссии после ремонта карданного вала', caption: 'Вибрация после ремонта кардана — ищите в шлицах и подвесном подшипнике' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/driveshafts-kb-6-shaft.jpg',
        readTime: '5 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/driveshafts-kb-7-propshaft.jpg', alt: 'Шлицевое соединение карданного вала — скользящая вилка', caption: 'Скользящая вилка кардана — телескопическое звено, компенсирующее ход подвески' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/driveshafts-kb-7-propshaft.jpg',
        readTime: '4 мин',
    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/cm-kb-4-profsheet.jpg', alt: 'Толщина профлиста — сравнение 0.4, 0.5 и 0.7 мм', caption: 'Профлист 0.5 мм — стандарт для большинства задач; 0.7 мм — для нагруженных кровель' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/cm-kb-4-profsheet.jpg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/cm-kb-5-seam-roof.jpg', alt: 'Фальцевая кровля — соединение листов без сквозных проколов', caption: 'Фальцевый шов: герметичное соединение без гвоздей — принцип защёлки' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/cm-kb-5-seam-roof.jpg',
        readTime: '5 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/cm-kb-6-profiles.jpg', alt: 'Каркасные профили C, U, UA, CW для гипсокартонных перегородок', caption: 'C и U — стандарт, UA и CW — для несущих конструкций и высоких перегородок' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/cm-kb-6-profiles.jpg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/cm-kb-7-sip.jpg', alt: 'SIP-панель в разрезе — OSB и пенополистирол', caption: 'SIP-панель в разрезе: OSB + ПСБ-С = прочная несущая конструкция' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/cm-kb-7-sip.jpg',
        readTime: '5 мин',
    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/vent-kb-4-ducts.jpg', alt: 'Скорость воздуха и сечение воздуховода — аэродинамический расчёт', caption: 'Правильное сечение воздуховода обеспечивает тихую работу системы' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/vent-kb-4-ducts.jpg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/vent-kb-5-ac.jpg', alt: 'Нержавеющие воздуховоды для кухонной вытяжки и пищевого производства', caption: 'Нержавеющие воздуховоды — обязательны для кухонь и химических производств' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/vent-kb-5-ac.jpg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/vent-kb-6-interior.jpg', alt: 'Загрязнение воздуховода — жировые отложения в кухонной вытяжке', caption: 'Жировые отложения в вытяжном воздуховоде — риск пожара и снижение тяги' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/vent-kb-6-interior.jpg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/vent-kb-7-venting.jpg', alt: 'Балансировка вентиляционной системы — регулировка расходов по зонам', caption: 'Регулирующие клапаны балансируют расход воздуха по ветвям системы' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/vent-kb-7-venting.jpg',
        readTime: '5 мин',
    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/fast-kb-4-screws.jpg', alt: 'Оцинкованные и нержавеющие саморезы для наружного применения', caption: 'Кровельные саморезы с цинковым покрытием и EPDM-шайбой — стандарт для улицы' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/fast-kb-4-screws.jpg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/fast-kb-5-fasteners.jpg', alt: 'Сравнение гвоздя и самореза — направление нагрузки', caption: 'Гвоздь — на срез, саморез — на вырывание: выбор зависит от направления нагрузки' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/fast-kb-5-fasteners.jpg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/fast-kb-6-bolts.jpg', alt: 'Класс прочности болтов 8.8, 10.9, 12.9 — маркировка на головке', caption: 'Маркировка на болте: класс прочности определяет допустимый момент затяжки' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/fast-kb-6-bolts.jpg',
        readTime: '5 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/fast-kb-7-anchor.jpg', alt: 'Дюбели для разных типов оснований — бетон, кирпич, газобетон', caption: 'Разные основания — разные дюбели: выбор по типу материала, а не только по размеру' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/fast-kb-7-anchor.jpg',
        readTime: '4 мин',
    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/rec-kb-4-pellets.jpg', alt: 'Качество пеллет — разные классы по зольности и теплотворности', caption: 'Класс A1 и B: разная зольность — разная частота обслуживания котла' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/rec-kb-4-pellets.jpg',
        readTime: '5 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/rec-kb-5-codes.svg', alt: 'Маркировка пластика 1-7 — типы полимеров', caption: 'Маркировка 1–7: тип полимера, а не «можно переработать»' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/rec-kb-5-codes.svg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/rec-kb-6-packaging.jpg', alt: 'Многослойная упаковка — не перерабатывается без специального оборудования', caption: 'Тетрапак — пример многослойной упаковки, не пригодной для стандартной переработки' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/rec-kb-6-packaging.jpg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/rec-kb-7-shredder.jpg', alt: 'Промышленный шредер для измельчения пластика и дерева', caption: 'Промышленный шредер: низкие обороты, высокий момент, крупная фракция' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/rec-kb-7-shredder.jpg',
        readTime: '4 мин',
    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/3dp-kb-4-fdm.png', alt: 'Точность 3D-печати FDM и SLA — сравнение технологий', caption: 'SLA даёт точность ±0.05 мм; FDM — ±0.2–0.5 мм в реальных условиях' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/3dp-kb-4-fdm.png',
        readTime: '5 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/3dp-kb-5-support.png', alt: 'Поддержки при 3D-печати FDM — нависающие элементы', caption: 'Поддержки строятся под нависающими элементами и удаляются после печати' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/3dp-kb-5-support.png',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/3dp-kb-6-petg.jpg', alt: 'ABS и PETG — сравнение свойств пластиков для 3D-печати', caption: 'PETG: лёгкая печать без коробления; ABS: выше термостойкость' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/3dp-kb-6-petg.jpg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/3dp-kb-7-slm.jpg', alt: 'Металлическая 3D-печать DMLS — спекание металлического порошка лазером', caption: 'DMLS: детали со сложной геометрией, недостижимой фрезеровкой' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/3dp-kb-7-slm.jpg',
        readTime: '5 мин',
    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/cont-kb-4-piles.jpg', alt: 'Фундамент под контейнерный модуль — свайный и блочный варианты', caption: 'Бетонные блоки или винтовые сваи — быстрое основание без заливки фундамента' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/cont-kb-4-piles.jpg',
        readTime: '4 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/cont-kb-5-insulation.jpg', alt: 'Конденсат в контейнерном модуле — паробарьер и утепление', caption: 'Паробарьер изнутри утеплителя исключает конденсат внутри стенового «пирога»' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/cont-kb-5-insulation.jpg',
        readTime: '5 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/cont-kb-6-construction.jpg', alt: 'Контейнерный модуль как временное строение без разрешения на строительство', caption: 'Модуль на блоках или сваях — временное строение, не требующее разрешения' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/cont-kb-6-construction.jpg',
        readTime: '5 мин',
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: 'https://s3.datary-dev.ru/tp1219/articles/cont-kb-7-container.jpg', alt: 'Состыковка контейнерных модулей — горизонтальная и вертикальная компоновка', caption: 'Два модуля рядом или двухэтажное размещение — разные решения для разных участков' },
        ...
        image: 'https://s3.datary-dev.ru/tp1219/articles/cont-kb-7-container.jpg',
        readTime: '5 мин',
