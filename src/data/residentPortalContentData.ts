    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Сравнение фитингов BSP, JIC и ORFS — разные стандарты резьбы', caption: 'Фитинги BSP, JIC, ORFS: один размер, разная геометрия уплотнения' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Потение рукава высокого давления — признак деградации материала', caption: 'Масляная пропитка внешней оплётки — сигнал к немедленной замене' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Промывка гидравлической системы после ремонта РВД', caption: 'Промывка системы — обязательный шаг после аварийного ремонта' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Нержавеющие и стальные оцинкованные фитинги для РВД', caption: 'Нержавеющие фитинги — для агрессивных сред и пищевого производства' },
    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Правка колёсного диска после деформации', caption: 'Правка диска восстанавливает геометрию без замены — при отсутствии трещин' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Балансировка колёс на стенде после шиномонтажа', caption: 'Балансировочный стенд определяет дисбаланс с точностью до 1 грамма' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Диагностика трансмиссии после ремонта карданного вала', caption: 'Вибрация после ремонта кардана — ищите в шлицах и подвесном подшипнике' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Шлицевое соединение карданного вала — скользящая вилка', caption: 'Скользящая вилка кардана — телескопическое звено, компенсирующее ход подвески' },
    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Толщина профлиста — сравнение 0.4, 0.5 и 0.7 мм', caption: 'Профлист 0.5 мм — стандарт для большинства задач; 0.7 мм — для нагруженных кровель' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Фальцевая кровля — соединение листов без сквозных проколов', caption: 'Фальцевый шов: герметичное соединение без гвоздей — принцип защёлки' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Каркасные профили C, U, UA, CW для гипсокартонных перегородок', caption: 'C и U — стандарт, UA и CW — для несущих конструкций и высоких перегородок' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'SIP-панель в разрезе — OSB и пенополистирол', caption: 'SIP-панель в разрезе: OSB + ПСБ-С = прочная несущая конструкция' },
    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Скорость воздуха и сечение воздуховода — аэродинамический расчёт', caption: 'Правильное сечение воздуховода обеспечивает тихую работу системы' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Нержавеющие воздуховоды для кухонной вытяжки и пищевого производства', caption: 'Нержавеющие воздуховоды — обязательны для кухонь и химических производств' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Загрязнение воздуховода — жировые отложения в кухонной вытяжке', caption: 'Жировые отложения в вытяжном воздуховоде — риск пожара и снижение тяги' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Балансировка вентиляционной системы — регулировка расходов по зонам', caption: 'Регулирующие клапаны балансируют расход воздуха по ветвям системы' },
    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Оцинкованные и нержавеющие саморезы для наружного применения', caption: 'Кровельные саморезы с цинковым покрытием и EPDM-шайбой — стандарт для улицы' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Сравнение гвоздя и самореза — направление нагрузки', caption: 'Гвоздь — на срез, саморез — на вырывание: выбор зависит от направления нагрузки' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Класс прочности болтов 8.8, 10.9, 12.9 — маркировка на головке', caption: 'Маркировка на болте: класс прочности определяет допустимый момент затяжки' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Дюбели для разных типов оснований — бетон, кирпич, газобетон', caption: 'Разные основания — разные дюбели: выбор по типу материала, а не только по размеру' },
    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Качество пеллет — разные классы по зольности и теплотворности', caption: 'Класс A1 и B: разная зольность — разная частота обслуживания котла' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Маркировка пластика 1-7 — типы полимеров', caption: 'Маркировка 1–7: тип полимера, а не «можно переработать»' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Многослойная упаковка — не перерабатывается без специального оборудования', caption: 'Тетрапак — пример многослойной упаковки, не пригодной для стандартной переработки' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Промышленный шредер для измельчения пластика и дерева', caption: 'Промышленный шредер: низкие обороты, высокий момент, крупная фракция' },
    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Точность 3D-печати FDM и SLA — сравнение технологий', caption: 'SLA даёт точность ±0.05 мм; FDM — ±0.2–0.5 мм в реальных условиях' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Поддержки при 3D-печати FDM — нависающие элементы', caption: 'Поддержки строятся под нависающими элементами и удаляются после печати' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'ABS и PETG — сравнение свойств пластиков для 3D-печати', caption: 'PETG: лёгкая печать без коробления; ABS: выше термостойкость' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Металлическая 3D-печать DMLS — спекание металлического порошка лазером', caption: 'DMLS: детали со сложной геометрией, недостижимой фрезеровкой' },
    ...
    knowledgeArticles: [
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Фундамент под контейнерный модуль — свайный и блочный варианты', caption: 'Бетонные блоки или винтовые сваи — быстрое основание без заливки фундамента' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Конденсат в контейнерном модуле — паробарьер и утепление', caption: 'Паробарьер изнутри утеплителя исключает конденсат внутри стенового «пирога»' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Контейнерный модуль как временное строение без разрешения на строительство', caption: 'Модуль на блоках или сваях — временное строение, не требующее разрешения' },
      ...
      },
      {
        ...
        contentBlocks: [
          ...
          { type: 'image', src: '', alt: 'Состыковка контейнерных модулей — горизонтальная и вертикальная компоновка', caption: 'Два модуля рядом или двухэтажное размещение — разные решения для разных участков' },
